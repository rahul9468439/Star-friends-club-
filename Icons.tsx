...
export const CrownIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M2 4l3 12h14l3-12-10 6-10-6z" />
  </svg>
);
...
export const AppIcon: React.FC<IconProps> = ({ className }) => (
    ...
    >
        <defs>
            <linearGradient id="bg-gradient-app-icon" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#4F46E5" />
                <stop offset="100%" stopColor="#3B82F6" />
            </linearGradient>
        </defs>
        <rect width="100" height="100" rx="20" fill="url(#bg-gradient-app-icon)" />
        <g fill="white">
            <circle cx="35" cy="35" r="10" />
            <path d="M 35 45 A 20 20 0 0 0 35 85 Z" />
            <circle cx="65" cy="35" r="10" />
            <path d="M 65 45 A 20 20 0 0 1 65 85 Z" />
            <rect x="42" y="55" width="16" height="8" rx="4"/>
        </g>
    </svg>
);